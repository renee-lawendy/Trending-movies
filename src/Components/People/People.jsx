...
export default function People() {
  ...
  const {data,isLoading,errorMessage}= useFetch(`https://api.themoviedb.org/3/person/popular?api_key=e5b977d149f2951f7a25e257e3f62068&language=en-US&page=${page}`)
