...
export default function Movies() {
  ...
  const { data, isLoading, error } = useFetch(`https://api.themoviedb.org/3/discover/movie?api_key=e5b977d149f2951f7a25e257e3f62068&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=${page}`)
