...
export default function MediaDetails() {
    ...
    const { data, isLoading, errorMessage } = useFetch(`https://api.themoviedb.org/3/${media_type}/${id}?api_key=e5b977d149f2951f7a25e257e3f62068&language=en-US`)
  ...
  <div className="row pt-5 gx-5 ">
    ...
    {errorMessage.length > 0 && <div className='text-center'>
    <h3>Error</h3>
        <p>{errorMessage}</p>
